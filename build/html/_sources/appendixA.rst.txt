...
.. dropdown:: astah* SysML メニューID一覧
   ...
   ============================================ ======================================= 
    ...
    要求図                                       diagram/requirement_diagram             
    要求テーブル                                 diagram/requirement_table               
    ブロック定義図                               diagram/block_definition_diagram                   
    内部ブロック定義図                           diagram/internal_block_diagram                   
    パラメトリック図                             diagram/parametric_diagram                   
    ユースケース図                               diagram/usecase_diagram                 
    ステートマシン図                             diagram/state_chart_diagram             
    アクティビティ図                             diagram/activity_diagram                
    シーケンス図                                 diagram/sequence_diagram                
    ...
    astah* ウェブサイト                          help/jude_home                          
    astah* コミュニティサイト                    help/jude_community                     
    astah* SysMLチュートリアルサイト             help/jude_help                          
    astah* SysML API利用ガイドサイト             help/sysml_api_guide                          
    ようこそastah* SysMLへ                       help/welcome                            
    バグ報告                                     help/bug_info_community                 
    サポートへの問い合わせ                       help/jude_support_site                  
    プラグイン一覧                               help/plugin_list                        
    ソフトウェアの更新確認                       help/check_version                      
...
.. dropdown:: astah* System Safety メニューID一覧

   astah* System Safety メニューID一覧
   =======================================================
   ...
   ============================================ ======================================= 
    ...
    プロジェクトの別名保存                       file/saveas                             
    プロジェクトを閉じる                         file/close                              
    プロジェクトの比較とマージ                   file/compare_project               
    印刷設定(プロジェクト)                       file/print_setup                        
    印刷設定(図)                                 file/print_setup_dgm                    
    印刷プレビュー                               file/print_preview                      
    印刷                                         file/print                              
    ...
    全選択                                       edit/select_all                         
    順序                                         edit/arrange_depth                      
    SysML 要求図                                 diagram/sysml_requirement_diagram       
    SysML 要求テーブル                           diagram/sysml_requirement_table         
    SysML ブロック定義図                         diagram/sysml_block_definition_diagram  
    SysML 内部ブロック図                         diagram/sysml_internal_block_diagram    
    SysML パラメトリック図                       diagram/sysml_parametric_diagram        
    SysML ユースケース図                         diagram/sysml_usecase_diagram           
    SysML ステートマシン図                       diagram/sysml_state_chart_diagram       
    SysML アクティビティ図                       diagram/sysml_activity_diagram          
    SysML シーケンス図                           diagram/sysml_sequence_diagram          
    STAMP/STPA 前提条件表                        diagram/stamp/precondition_table        
    STAMP/STPA アクシデントハザード安全制約表    diagram/stamp/accident_hazard_safety_constraint_table
    STAMP/STPA コントロールストラクチャー図      diagram/stamp/control_structure_diagram 
    STAMP/STPA UCA表                             diagram/stamp/uca_table                 
    STAMP/STPA コントロールループ図              diagram/stamp/control_loop_diagram      
    STAMP/STPA ロスシナリオ表                    diagram/stamp/hcf_table                 
    STAMP/STPA 対策表                            diagram/stamp/countermeasure_table      
    GSN/D-CASE図                                 diagram/gsn/gsn_diagram                 
    SCDL/安全コンセプト図                        diagram/scdl/safety_concept_diagram
    マインドマップ                               diagram/mind_map_diagram                
    横の整列                                     alignment/align_horizontally            
    縦の整列                                     alignment/align_vertically              
    サイズ揃え                                   alignment/align_size                    
    ...
    他のタブを閉じる                             window/close_other                      
    全て閉じる                                   window/close_all                        
    上下に並べて表示                             window/align_horizontally               
    左右に並べて表示                             window/align_vertically                 
    上下左右に並べて表示                         window/align_tile                       
    インストール済みプラグイン                   plugin/installed_plugin_list            
    サポートへの問い合わせ                       help/jude_support_site                  
    astah* ウェブサイト                          help/jude_home                          
    astah* リファレンスマニュアル                help/jude_help                          
    ライセンスの設定                             help/check_license                        
    ソフトウェアの更新確認                       help/check_version                      
    バージョン情報                               help/version                            
   ============================================ ======================================= 

...
project = u'astah* Plug-in 開発チュートリアル'
copyright = u'2014, Change Vision,inc'
...
latex_documents = [
  ('index', 'astahPlug-inSDKDocument.tex', u'astah* Plug-in SDK Document Documentation',
...
pdf_documents = [
    ('index', u'astah-plugin-tutorial', u'astah*プラグイン開発チュートリアル', u'Change Vision inc,'),
]
